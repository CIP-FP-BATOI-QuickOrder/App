...
class NewPaymentFormWidget extends StatefulWidget {
  ...
  @override
  State<NewPaymentFormWidget> createState() => _NewPaymentFormWidgetState();
}

class _NewPaymentFormWidgetState extends State<NewPaymentFormWidget> {
  @override
